...
// different scenario. For now every venue shares the same cast and group
// size until the artistic team finalizes each site's scenario.
const GROUP_SIZE = 5;

// Fixed positions for the SESA scripted-score pilots (P1..P5) — each
// participant's place in the score's timed, per-position cue sequence.
const DEFAULT_ROLE_DECK = ['p1', 'p2', 'p3', 'p4', 'p5'];
